...
namespace DALTestHarness
{
    ...
    public class DALTest
    {
        ...
        */
        ...
        /*
         * Name: CheckUserAccessTest
         * 
         * Description: The purpose of this test is to test the check the UserStatus method to see if the 
         *              database will return that it has not found a user that matches this description.
         *              If a user has been found in the database, it will return a status of true, or a status of 
         *              false if the user is not found in the database
         * 
        ...
        */
        ...
        public void CheckUserAccessTest()
        {
            ...
            bool status = theData.UserStatus("SELECT COUNT(*) FROM UsersTable WHERE Name = 'admin' AND ThePassword = '123456' ");

            Assert.AreEqual(false, status);
        }

        /*
         * Name: RetrieveCountTest
         * 
         * Description: The purpose of this test is to see if the RetrieveCoumt method can in fact retrive a count value
         *              from the database. Typically it would retrieve data associated with completing excel charts but
         *              because the value of the number of items is unknown, it is being tested on the types of Yoyos. 
         * 
         * Expected Result: 7
         * Actual Result:   7
         * 
        */
        ...
        public void RetrieveCountTest()
        {
            ...
            int status = theData.RetrieveCount("SELECT COUNT(*) FROM SKUTable");

            Assert.AreEqual(7, status);
        }
    }
}
